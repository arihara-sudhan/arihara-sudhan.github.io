...
\begin{itemize}
\item[]
    \ressubheading{Einstein College of Engineering}{Tirunelveli, India}{B.E., Computer Science and Engineering (CGPA: 8.97)}{2019 - 2023}
...
\item[]
    ...
    \begin{itemize}
        \resitem{\textit{Built a HIPAA-compliant end-to-end automation pipeline using UiPath that identifies claims requiring statusing, automates portal navigation to retrieve claim status, leverages LLMs to generate concise summaries, and securely writes results back into the system while ensuring proper PHI handling for revenue cycle optimization.}}
